...
C0 <- read_rds('cache/outputs_modelos/12_periodos/C0.rds')

m0 <- read_rds('cache/outputs_modelos/12_periodos/m0.rds')
...
V <- read_rds('cache/outputs_modelos/12_periodos/V.rds')
